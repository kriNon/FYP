...
for eps in range(episodes):
	...
	for t in range(steps):
		...
		if t%5 == 0:
			i = ('000' + str(t//5))[-3:]
			scipy.misc.imsave(f'C:/Users/Kristopher_2/FYP/CarRacing/rollouts/CarRacing/car_{eps}_{i}.jpg', obs)

			#imageio.imwrite(f'rollouts/CarRacing/car_{eps}_{i}.jpg', obs)
